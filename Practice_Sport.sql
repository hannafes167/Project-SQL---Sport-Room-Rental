...
SELECT *FROM member_bookings;
 ...
 -- My little skenario --
CALL insert_new_members ('stari', 'stari99', 'Meisya_Staria99');
SELECT * FROM members ORDER BY member_since DESC;
CALL search_room ('MPF2', '2024-06-15', '10:00:00'); -- AVAILABLE 
CALL make_booking ('MPF2', '2024-06-15', '10:00:00', 'stari'); -- PAID AS ROOM TYPE
SELECT * FROM bookings; -- ID 19
SELECT * FROM rooms;
CALL update_payment (19); -- PAID
CALL view_bookings (19); -- DONE
CALL cancel_booking (19, @message);
SELECT @message;
SELECT *FROM member_bookings;
